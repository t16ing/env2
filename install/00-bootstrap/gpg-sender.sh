...
if [[ $answer == "y" ]]; then
  ...
  # Waiting for Destination Ready
  echo "Press Enter if $destination is ready and requesting for ssh keys (enter):"
  read wait
  ...
  # Sensitive Data Has Been Translated, Delete Destination's GPG Public Key
